                            ...
                            <div class="card-body">
                                <div class="tab-content" id="custom-tabs-four-tabContent">
                                    <div class="tab-pane fade active show" id="custom-tabs-four-home" role="tabpanel" aria-labelledby="custom-tabs-four-home-tab">
                                        <form action="<?php echo base_url('admin/category_update_action') ?>" method="post" enctype="multipart/form-data">
                                            <div class="row">
                                                <div class="col-md-6">
                                                        ...
                                                        <select name="parent_id" class="form-control text-capitalize">
                                                            ...
                                                            <?php foreach ($allcategory as $cat) { ?>
                                                                <option value="<?php echo $cat->cat_id; ?>" <?php echo ($cat->cat_id == $category->parent_id) ? 'selected' : ''; ?>>
                                                                    <?php echo display_category_with_parent($cat->cat_id);?>
                                                                </option>
                                                            <?php } ?>
                                                    ...
                                                    <a href="<?php echo base_url('admin/category') ?>" class="btn btn-danger">Back</a>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        <label>Popular</label>
                                                        <?php $checkPop = is_exists('cc_category_popular', 'cat_id', $category->cat_id); ?>
                                    ...
                                    <div class="tab-pane fade" id="custom-tabs-four-profile" role="tabpanel" aria-labelledby="custom-tabs-four-profile-tab">
                                        <form action="<?php echo base_url('admin/category_update_action_others') ?>" method="post" enctype="multipart/form-data">
                                            <div class="row">
                                                <div class="col-md-6">
