        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <a href="<?php echo base_url('admin/category_create') ?>" class="btn btn-primary btn-block btn-xs"><i class="fas fa-plus"></i> Add</a>
                    </div>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php echo display_category_with_parent($val->cat_id); ?></td>
                                ...
                                <td width="180">
                                    <a href="<?php echo base_url('admin/category_update/' . $val->cat_id); ?>" class="btn btn-primary btn-xs"><i class="fas fa-edit"></i> Update</a>
                                    <a href="<?php echo base_url('admin/category_delete/' . $val->cat_id); ?>" onclick="return confirm('Are you sure you want to Delete?')" class="btn btn-danger btn-xs"><i class="fas fa-trash"></i> Delete</a>
                                </td>
                            </tr>
                        <?php } ?>
