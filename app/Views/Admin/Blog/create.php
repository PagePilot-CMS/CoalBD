                    ...
                    <div class="row">
                            ...
                            <div class="form-group category">
                                ...
                                <select class="select2bs4" name="cat_id" data-placeholder="Select a Category" style="width: 100%;" required>
                                    ...
                                    <?php foreach ($category as $cat) { ?>
                                        <option value="<?php echo $cat->cat_id; ?>"><?php echo display_category_with_parent($cat->cat_id); ?></option>
                                    <?php } ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" id="editor" rows="4" class="form-control" placeholder="Description" ></textarea>
                            </div>
